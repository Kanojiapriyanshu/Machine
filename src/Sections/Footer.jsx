              ...
              <div className="pl-0 md:pl-10 border-t md:border-t-0 md:border-l md:border-gray-200 pt-6 md:pt-0">
                ...
                <div className="max-w-[1000px] mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-[#496162] mb-8">
                    ...
                    {/* 📱 MOBILE NUMBERS */}
                    <div>
                      <div className="text-xs font-semibold text-[#334746] mb-1">
                        MOBILE
                      </div>
                      ...
                      {/* ☎ LANDLINE */}
                      <div className="text-xs font-semibold text-[#334746] mt-4 mb-1">
                        LANDLINE
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        />
                        <a
                          href="https://www.energeticengineering.in"
                          target="_blank"
                          rel="noreferrer"
                          className="hover:underline"
                        >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-[#6b7a79]">
                    <div>
                      <div className="text-sm font-semibold text-[#334746] mb-2">
                        LOCATION
                      </div>
      ...
      <div className="w-full bg-white border-t border-gray-100">
        <div className="max-w-[1440px] xl:max-w-[1920px] mx-auto px-4 md:px-12 lg:px-20 xl:px-27 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#9aa8a8]">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://nowt.framer.website/"
              target="_blank"
              rel="noreferrer"
            >
              <img
                src={NowtLogo}
                alt="Designed by Nowt"
